...
def load_model():
    print("----Loading model...")
    print(os.path.join(os.getcwd(), "static\model\word2vec_NP.bin"))
    return  KeyedVectors.load_word2vec_format(os.path.join(os.getcwd(), "static\model\word2vec_NP.bin"), binary=True)
    #return Word2Vec.load(os.path.join(os.getcwd(), "static\model\word2vec_NP.bin"))
